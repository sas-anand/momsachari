...
const PrivacyPol = () => {
  //return <h1>About</h1>;
    return (
      <div className="privacypol-topcontainer">
        <div className="mt-4">
        </div>
        <div className="privacypol-innercontainer">
          {/* Our Story */}
          <div className="d-flex justify-content-between mt-5 privacypolDiv">
            <div className="w-90 privacypoltText">
            <h3 className="fw-bold privacypolHeading">Who we are?</h3>
              <p className="mt-3">
          ...
          {/* Our Mission */}
          <div className="d-flex justify-content-between mt-5 privacypolDiv">
            <div className="w-90 privacypolText">
              <h3 className="fw-bold privacypolHeading">Our Mission</h3>
              <p className="mt-3">
          ...
          <div className="d-flex justify-content-between mt-5 privacypolDiv">
            <div className="w-90 privacypolText">
              <h3 className="fw-bold privacypolHeading">Our Team</h3>
              <p className="mt-3">
